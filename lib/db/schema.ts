...
export const runs = sqliteTable("runs", {
  ...
  audioMdPath: text("audio_md_path"),
  totalAudioCostUsd: real("total_audio_cost_usd"),
  totalAudioDurationMs: integer("total_audio_duration_ms"),
  videoPath: text("video_path"),
  srtPath: text("srt_path"),
  videoMdPath: text("video_md_path"),
  totalVideoDurationMs: integer("total_video_duration_ms"),
